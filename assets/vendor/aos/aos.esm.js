...
function check(mutations) {
  ...
  mutations.forEach(function (mutation) {
    var addEndodes = Array.prototype.slice.call(mutation.addEndodes);
    var removEndodes = Array.prototype.slice.call(mutation.removEndodes);
    var allNodes = addEndodes.concat(removEndodes);
